...
products | "products": [ { "sku": "AS123", "productSkuAbTest": true }, { "sku": "AS987", "productSkuAbTest": false } ] | This is the products list when user visit, buy, return products then add it like this format. <td>This is the products list when user visit, buy, return products then add it like this format.
